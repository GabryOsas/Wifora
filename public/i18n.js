...
export const translations = {
  it: {
    ...
    toastDspPure: "Ottimizzazione DSP: Diretto Bit-Perfect (Zero DSP)",
    ...
    feature3Title: "10 ms & Protezione Anti-Lag FEC",
    feature3Desc: "Frame a 10 ms con correzione errori Forward Error Correction per annullare micro-scatti.",
    ...
    advancedIntro: "Wifora integra il motore ANAE che regola automaticamente bitrate (96–384 kbps) e buffer in tempo reale. Se preferisci, puoi forzare un profilo manuale qui sotto:",
    ...
    profileLowLatency: "Gaming & Ultra Bassa Latenza (160 kbps CBR • 20ms)",
    ...
    dspPure: "Diretto Bit-Perfect (Zero DSP • 100% Puro)",
    ...
    tierMaster: "Master Hi-Fi (384k)",
    tierHd: "Studio HD (288k)",
    tierStandard: "Standard (200k)",
    tierAntiLag: "Anti-Lag (140k)",
    tierWeak: "Rete Debole (96k)",
  ...
  en: {
    ...
    toastDspPure: "DSP Profile: Direct Bit-Perfect (Zero DSP)",
    ...
    feature3Title: "10 ms & Anti-Lag FEC Protection",
    feature3Desc: "10 ms audio frames with Forward Error Correction to eliminate micro-stutters.",
    ...
    advancedIntro: "Wifora features the ANAE engine to automatically tune bitrate (96–384 kbps) and latency in real time. You can also manually pick a profile below:",
    ...
    dspPure: "Direct Bit-Perfect (Zero DSP • 100% Pure)",
  ...
  fr: {
    ...
    toastDspPure: "Traitement DSP : Direct Bit-Perfect (Zéro DSP)",
    ...
    feature3Title: "10 ms & Protection Anti-Lag FEC",
    feature3Desc: "Trames de 10 ms avec correction d'erreurs directe (FEC) pour éliminer les micro-coupures.",
    ...
    advancedIntro: "Wifora intègre le moteur ANAE pour ajuster automatiquement le débit (96–384 kbps) et la latence en temps réel :",
    profileLabel: "Profil de Transmission",
    dspLabel: "Traitement Audio DSP",
    profileAdaptive: "Auto Intelligent (Dynamique & Sûr • 96-256k)",
    profileLowLatency: "Gaming & Ultra Basse Latence (160 kbps CBR • 20ms)",
    profileHifi: "Studio Hi-Fi Master (384 kbps • Fullband 48 kHz)",
    profileEco: "Éco & Stabilité Maximale (96 kbps)",
    dspClarity: "Studio Clarity & Anti-Clipping (Recommandé)",
    dspPure: "Direct Bit-Perfect (Zéro DSP • 100% Pur)",
  ...
  de: {
    ...
    toastDspPure: "DSP-Optimierung: Direkt Bit-Perfect (Kein DSP)",
    ...
    feature3Title: "10 ms & Anti-Lag FEC-Schutz",
    feature3Desc: "10-ms-Audio-Frames mit Forward Error Correction zur Beseitigung von Mikrorucklern.",
    ...
    optionalBadge: "Optional",
    advancedIntro: "Wifora passt Bitrate (96–384 kbps) und Latenz mit dem ANAE-Motor automatisch in Echtzeit an:",
    profileLabel: "Übertragungsprofil",
    dspLabel: "Audio-DSP-Verarbeitung",
    profileAdaptive: "Smart Auto (Dynamisch & Stabil • 96-256k)",
    profileLowLatency: "Gaming & Ultra-Niedrige Latenz (160 kbps CBR • 20ms)",
    profileHifi: "Studio Hi-Fi Master (384 kbps • Fullband 48 kHz)",
    profileEco: "Öko & Maximale Stabilität (96 kbps)",
    dspClarity: "Studio Clarity & Anti-Clipping (Empfohlen)",
    dspPure: "Direkt Bit-Perfect (Kein DSP • 100% Rein)",
